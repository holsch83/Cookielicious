...
#ifndef Cookielicious_Constants_h
#define Cookielicious_Constants_h

extern NSString * const CL_API_URL;
extern NSString * const CL_API_ASSETSURL;

extern NSString * const CL_API_JSON_IDKEY;
extern NSString * const CL_API_JSON_NAMEKEY;
extern NSString * const CL_API_JSON_AMOUNTKEY;
extern NSString * const CL_API_JSON_UNITKEY;
extern NSString * const CL_API_JSON_PREPARATIONTIMEKEY;
